...
class GameToolSettings:
    def __init__(self, game_instance):
        ...
        # Boundary settings
        self.left_boundary = self.settings.left_boundary
        self.lb_begin = (self.left_boundary, 0)
        self.lb_end = (self.left_boundary, self.screen_height)

        self.bottom_boundary = self.settings.bottom_boundary
        self.bb_begin = (0, self.bottom_boundary)
        self.bb_end = (self.screen_width, self.bottom_boundary)

        self.top_boundary = self.settings.top_boundary
